...
void challenge1() {
  ...
  if(mood == "tired") {
    ...
    recommendation = "Short Comedy Series";
  } else if(watchingWithFriends == true && mood =="excited" && hasWatchedAction == false) {
    recommendation = "Action Movie";
  } else if(watchingWithFriends == true && mood == "happy") {
    recommendation = "Comedy Movie";
  } else if(watchingWithFriends == true && mood == "sad") {
    recommendation = "Feel-good Romance";
  } else if(watchingWithFriends == false && mood == "excited") {
    recommendation = "Thriller Series";
  } else if(watchingWithFriends == false && mood == "happy") {
    recommendation = "Comedy Special";
  } else if(watchingWithFriends == false && mood == "sad") {
    recommendation = "Drama Series";
  } else {
    recommendation = "Popular Trending Show";
  }
  // Display the result
...
void challenge2() {
  ...
  totalPrice = (basePrice + sizeUpcharge) * 0.1;

if (timeOfDay == "morning" && drinkType == "coffee" || drinkType == "latte") {
  suggestedExtra ="pastry";
} else if(timeOfDay == "afternoon" && drinkType == "tea"){
  suggestedExtra = "cookie";
} else if(timeOfDay == "evening" && hasLoyaltyCard == true){
  suggestedExtra = "dessert special";
} else{
  suggestedExtra = "nothing extra";
}
